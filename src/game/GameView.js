...
exports.TOP_HAND_POS = {x:WIDTH / 2, y:-Resources._sprite_blueCardBack.height + 40}
exports.TOP_BOARD_POS = {x:WIDTH / 2 - 1, y:HEIGHT / 2 - Resources._sprite_blueCardBack.height - 6}
exports.TOP_PLACE_POS = {x:272, y:47}
exports.TOP_DISCARDED_POS = {x:WIDTH + 50, y:HEIGHT / 2 - Resources._sprite_blueCardBack.height - 10}
exports.BOTTOM_DECK_POS = {x:37 - Resources._sprite_redCardBack.width, y:196 - Resources._sprite_redCardBack.height}
exports.BOTTOM_HAND_POS = {x:WIDTH / 2, y:HEIGHT - 40}
exports.BOTTOM_BOARD_POS = {x:WIDTH / 2 - 1, y:HEIGHT / 2 + 7}
exports.BOTTOM_PLACE_POS = {x:272, y:131}
exports.BOTTOM_DISCARDED_POS = {x:WIDTH + 50, y:HEIGHT / 2 + 10}
...
//     {
//         _spriteCount++
//         if (_spriteCount >= Resources.MAX_SPRITE_COUNT)
//         {
//             flush()
//         }
//     }
